...
<body class="ContentBody">
  ...
  <form action="method!banfeiupdate2" method="post"  >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >查看班费</th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				<fieldset style="height:100%;">
					  ...
					  <tr>
					    ...
					    <td width="41%">
					    <input name="feiyong" class="text" style="width:250px" type="text" size="40" value="${bean.feiyong }" readonly="readonly"/>
				        </td>
