...
<body class="ContentBody">
  ...
  <form action="method!chengjiupdate2" method="post"  onsubmit="return checkform()" >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >修改成绩</th>
  </tr>
  <tr>
    <td class="CPanel">
				...
				<fieldset style="height:100%;">
					  ...
					  <tr>
					   ...
					   <tr>
					    ...
					    <td width="41%">
					    <input name="chengji" id="chengjiid" class="text" style="width:250px" type="text" size="40" value="${bean.chengji }" />
				        </td>
					    
					  </tr>
					  
					   <input name="id" class="text" style="width:250px" type="hidden" size="40" value="${bean.id }" />
					  <input name="banjiid"  type="hidden" size="40" value="${banjiid }" />
