...
<body class="ContentBody">
  ...
  <form action="method!banjiadd2" method="post" onsubmit="return checkform()"  >
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >添加新班级</th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				<fieldset style="height:100%;">
					  ...
					  <tr>
					    ...
					    <option value="${bean22.nianji }">${bean22.nianji }</option>
					    </c:forEach>
					  ...
					  <tr>
					    ...
					    <td width="41%">
					    <input name="banjiming" id="banjimingid" class="text" style="width:250px" type="text" size="40" />
				        </td>
