...
<body class="ContentBody">
  ...
  <form action="method!banjiupdate2" method="post"  >
<div class="MainDiv">
			...
			<TD width="100%">
				<fieldset style="height:100%;">
					  ...
					  <tr>
					    ...
					    <td width="41%">
					    <input name="nianji" class="text" style="width:250px" type="text" size="40" value="${bean.nianji }" readonly="readonly"/>
				        </td>
					  ...
					  <tr>
					    ...
					    <td width="41%">
					    <input name="banjiming" class="text" style="width:250px" type="text" size="40" value="${bean.banjiming }"  readonly="readonly"/>
				        </td>
