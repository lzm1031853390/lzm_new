...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >添加新老师</th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				<fieldset style="height:100%;">
					  ...
					  <tr>
					    ...
					    <td width="41%">
					    <input name="username" id="usernameid" class="text" style="width:250px" type="text" size="40" />
				        </td>
					  ...
					  <tr>
					    ...
					    <td width="41%">
					    <input name="truename" id="truenameid" class="text" style="width:250px" type="text" size="40" />
				        </td>
